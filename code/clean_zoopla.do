...
preserve
	...
	save "$output_folder/zoopla_rents.dta", replace 
	
	keep if property_type == "Flat" | property_type == "Maisonette" | property_type == "Studio"
	save "$output_folder/zoopla_rents_flats.dta", replace 
restore

preserve
	keep if listing_status=="sale"
	save "$output_folder/zoopla_sales_flats.dta", replace 
